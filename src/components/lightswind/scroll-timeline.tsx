...
export const ScrollTimeline = ({
  ...
  // Single parallax transform applied uniformly (simpler & hook-safe)
      ...
      <div className="relative max-w-6xl mx-auto px-4 pb-24">
        <div className="relative mx-auto">
          <div
            className={cn(
              getConnectorClasses(),
              "h-full absolute top-0 z-10 hidden md:block"
            )}
          ></div>
            ...
            <>
              ...
              >
                <motion.div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle, rgba(59,130,246,0.85) 0%, rgba(96,165,250,0.55) 40%, rgba(191,219,254,0) 70%)",
                    boxShadow: `
                      0 0 12px 3px rgba(59,130,246,0.7),
                      0 0 24px 8px rgba(37,99,235,0.5),
                      0 0 38px 14px rgba(59,130,246,0.3)
                    `,
                  }}
                  animate={{
                    scale: [1, 1.3, 1],
            ...
            {events.map((event, index) => {
              return (
                ...
                >
                  <div
                    className={cn(
                      "absolute top-1/2 transform -translate-y-1/2 z-30 hidden md:block",
