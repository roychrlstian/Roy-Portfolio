...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 shadow-2xs bg-[#0f1724]">
      <Link href="/landing" className="shine-link text-center text-inter text-3xl text-white text-shadow-2xs font-bold border-5 py-1.5 px-4 rounded-xs rounded-br-xl">
