            ...
            <div className="mt-14 md:mt-0 md:w-1/2 md:pl-10 space-y-10">
              ...
              >
                ...
                <div>
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-full border border-white/40 hover:border-white px-14 h-14 text-sm tracking-wide font-medium transition-colors"
                  >
                    LET&apos;S TALK
                  </button>
                </div>
